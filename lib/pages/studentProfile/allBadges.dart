...
class _AllBadgesState extends State<AllBadges> {
  final CollectionReference collectionReference = FirebaseFirestore.instance.collection('batches');
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return ListTile(
                      trailing: IconButton(
                        ...
                        onPressed: () {
                          batchnameController.text = doc['batchname'];
